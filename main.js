...
function getDueInfo(isoDate) {
  ...
  if (diff === 1) return { label: `${dateStr} · tomorrow`,color: einkActive ? EINK_SOON_COLOR : '#BA7517', note: 'Tomorrow',noteColor: '#854F0B', urgency: 'soon' };
  if (diff <= 7)  return { label: `${dateStr} · ${diff} days`, color: einkActive ? EINK_SOON_COLOR : '#BA7517', note: `${diff} days`, noteColor: '#854F0B', urgency: 'soon' };
